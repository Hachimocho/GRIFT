...
class ModelOutnot(nn.Module):
	...
	def __init__(self, pretrained: bool = False, finetune : bool = False, exclude_top : bool = False,
		...
		self.fc2 = nn.Linear(16, output_classes)
...
class ModelOut(nn.Module):
	...
	"""
	def __init__(self, pretrained: bool = False, finetune : bool = False, exclude_top : bool = False,
                    output_classes: int = 1, classification_strategy: str = 'categorical', configuration: str = 'default'):
		super(ModelOut, self).__init__()
		self.output_classes = output_classes if classification_strategy == 'categorical' else 1
		#InceptionLayer1
		...
		self.dropout = nn.Dropout2d(0.5)
		self.fc1 = nn.Linear(16*8*8, 16)
		self.fc2 = nn.Linear(16, self.output_classes)
